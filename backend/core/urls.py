...
urlpatterns = [
    ...
    path('dashboard/', login_required(order_track_view), name='dashboard'),  # FIXME: should be dashboard_view
    ...
    path('orders/api/validate-discount/', login_required(views.validate_discount_code), name='validate_discount_code'),
